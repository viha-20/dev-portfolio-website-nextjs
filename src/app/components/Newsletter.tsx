...
const Newsletter = () => {
  return (
    <section className='py-20 bg-white dark:bg-dark/50 rounded-lg shadow-md overflow-hidden 
    animate-slide-up'>
            ...
            <div className='max-w-7xl mx-auto'>
                <div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-center'>
                    ...
                    <form className='flex flex-col md:flex-row gap-4'>
                        ...
                        rounded-lg dark:text-white border-gray-300 dark:border-gray-600 bg-white text-gray-500
